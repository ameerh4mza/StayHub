...
export default function ManagerBookingCard({
  booking,
}: {
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex flex-row lg:flex-col gap-3 lg:min-w-40">
          {currentStatus === "pending" && (
            <>
              <button
                ...
                disabled={isUpdating}
                className="flex-1 lg:flex-none bg-green-500 text-white px-4 py-3 rounded-lg hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors"
              >
              ...
              <button
                ...
                disabled={isUpdating}
                className="flex-1 lg:flex-none bg-red-500 text-white px-4 py-3 rounded-lg hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors"
              >
          ...
          {currentStatus === "confirmed" && (
            <div className="flex-1 lg:flex-none text-center py-3 px-4 bg-green-50 text-green-700 rounded-lg font-medium">
              ✓ Confirmed
            </div>
          )}

          {currentStatus === "rejected" && (
            <div className="flex-1 lg:flex-none text-center py-3 px-4 bg-red-50 text-red-700 rounded-lg font-medium">
              ✗ Rejected
            </div>
          )}

          {currentStatus === "cancelled_by_user" && (
            <div className="flex-1 lg:flex-none text-center py-3 px-4 bg-blue-50 text-blue-700 rounded-lg font-medium">
              Cancelled by User
            </div>
          )}
